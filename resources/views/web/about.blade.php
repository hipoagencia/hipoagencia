        ...
        <div class="container  pb-70">
            <div class="row justify-content-center0">
                ...
                <div class="col-lg-4 text-center about-box-top">
                    <img src="{{ url(asset('web/assets/images/boston/about/ico1.png')) }}" />
                    <h4>Análises e opiniões de especialistas em suas áreas de atuação.</h4>

                </div>

                <div class="col-lg-4 text-center about-box-top">
                    <img src="{{ url(asset('web/assets/images/boston/about/ico2.png')) }}" />
                    <h4>
                        Conhecimento
                        científico profundo
                        sobre condições
                ...
                <div class="col-lg-4 text-center about-box-top">
                    <img src="{{ url(asset('web/assets/images/boston/about/ico3.png')) }}" />
                    <h4>
                        Informações
