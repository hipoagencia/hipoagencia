...
<section class="half-section pt-0 home-personal-portfolio md-no-padding-bottom bg-extra-dark-gray">
    <div class="container-fluid">
        <div class="row row-cols-1 align-items-center">
            <div class="col col-md border border-right-0 border-left-0 border-bottom-0 border-color-medium-dark-gray sm-margin-30px-bottom"></div>
            <div class="col col-md-auto text-center padding-4-half-rem-lr md-padding-2-half-rem-lr xs-padding-1-half-rem-top xs-padding-2-rem-bottom wow animate__fadeIn"
                 data-wow-delay="0.4s">
                <span class="alt-font font-weight-300 title-large-2 text-white letter-spacing-minus-3px d-block md-line-height-normal">Vamos trabalhar <span
                        class="font-weight-600">juntos?</span></span>
            </div>
            <div class="col col-md border border-right-0 border-left-0 border-bottom-0 border-color-medium-dark-gray sm-margin-30px-top"></div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-4 text-center text-lg-end last-paragraph-no-margin">
                <p class="alt-font font-weight-600 text-small text-uppercase text-white">Hipo Agência © {{now()->year}} -
