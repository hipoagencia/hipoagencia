    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-6 col-lg-6 col-sm-8 text-center margin-5-rem-bottom wow animate__fadeIn">
                    <span
                        class="d-inline-block alt-font text-medium text-extra-dark-gray text-uppercase font-weight-500 margin-20px-bottom sm-margin-15px-bottom">Algumas empresas que já trabalharam conosco</span>
        ...
        <div class="row w-85 margin-auto justify-content-center">
            <div class="col-6 col-lg-3 col-md-6 col-sm-6 md-margin-30px-bottom wow animate__fadeIn text-center"
                 data-wow-delay="0.2s">
                <img src="{{ url(asset('web/assets/images/hipo/1.png')) }}" alt="Clientes da Hipo Agência">
            </div>
