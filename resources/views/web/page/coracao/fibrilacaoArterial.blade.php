    ...
    <div class="about-what-find-blue" style="background-color:#f5364a !important;">
        <div class="container  pb-70">
            <div class="row justify-content-center0">
                ...
                <div class="col text-center about-box-top">
                    <img src="{{ url(asset('web/assets/images/boston/specialities/ico11.png')) }}"/>
                    <p class="co-white">Palpitações cardíacas (sensação de ritmo cardíaco acelerado).</p>
                </div>

                <div class="col text-center about-box-top">
                    <img src="{{ url(asset('web/assets/images/boston/specialities/ico111.png')) }}"/>
                    <p class="co-white">Falta de energia.</p>
                </div>

                <div class="col text-center about-box-top">
                    <img src="{{ url(asset('web/assets/images/boston/specialities/ico1111.png')) }}"/>
                    <p class="co-white">Dificuldade em respirar durante atividades normais ou mesmo em repouso.</p>
                </div>

                <div class="col text-center about-box-top">
                    <img src="{{ url(asset('web/assets/images/boston/specialities/ico11111.png')) }}"/>
