                        ...
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="home1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status">
                                                ...
                                                <option
                                                    value="1" {{ ( old('status') == '1' ? 'selected' : ($content->status == '1' ? 'selected' : '' )) }}>
                                                    Ativo
                                                </option>
                                                <option
                                                    value="0" {{ ( old('status') == '0' ? 'selected' : ($content->status == '0' ? 'selected' : '' )) }}>
                                                    Inativo
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <textarea id="elm1" class="my-editor" name="description">{{ old('description') ?? $content->description }}</textarea>
                                    </div>
