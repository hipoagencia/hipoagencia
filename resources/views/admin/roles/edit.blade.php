                                        ...
                                        <div class="row">
                                            ...
                                            @foreach($permissions as $permission)
                                                ...
                                                <div class="form-check mb-3 col-md-3">
                                                    <input class="form-check-input checks" type="checkbox" name="roles[]" value="{{ $permission->name }}" id="{{ $permission->name }}" {{ ( $role->hasDirectPermission($permission->name) ? 'checked' : '' ) }}>
