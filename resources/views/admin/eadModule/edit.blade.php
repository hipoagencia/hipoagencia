    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.ead-module.update', ['ead_module' => $module->id]) }}" method="POST"
                          autocomplete="false"
                        ...
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="home1" role="tabpanel">
                                ...
                                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="formrow-inputState" class="form-select" name="user_id">
                                                ...
                                                @foreach($users as $user)
                                                    <option value="{{ $user->id }}" {{ ( $module->user_id == $user->id ? 'selected' : ( old('user_id') == $user->id ? 'selected' : '' ) ) }}>{{ $user->name }} {{ $user->last_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <select name="premium" class="form-select">
                                                ...
                                                <option
                                                    value="0" {{ (old('premium') == '0' ? 'selected' : ($module->premium == '0' ? 'selected' : '')) }}>
                                                    Não
                                                </option>
                                                <option
                                                    value="1" {{ (old('premium') == '1' ? 'selected' : ($module->premium == '1' ? 'selected' : '')) }}>
                                                    Sim
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="select2 form-control select2-multiple"
                                            ...
                                            @foreach($categories as $category)
                                                <option
                                                    value="{{ $category->id }}" {{ $category->id }}" {{ ($module->categories->find($category->id) == true ? 'selected' : (in_array($category->id, old("categories") ?: []) ? "selected" : "")) }}>{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <textarea id="elm1" name="description" >{{ old('description') ?? $module->description }}</textarea>
                                    </div>
                            ...
                            <div class="tab-pane" id="profile1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="content_image row">
                                        <div class="col-4">
                                            <img src="{{ asset($module->cover) }}" class="img-fluid"><br><br>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="headline" class="form-control"
                                                   value="{{ old('headline') ?? $module->headline }}">
                                        </div>
                                    </div>
