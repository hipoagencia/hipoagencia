                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status">
                                                ...
                                                <option
                                                    value="1" {{ ( old('status') == '1' ? 'selected' : ($product->status == '1' ? 'selected' : '' )) }}>
                                                    Ativo
                                                </option>
                                                <option
                                                    value="0" {{ ( old('status') == '0' ? 'selected' : ($product->status == '0' ? 'selected' : '' )) }}>
                                                    Inativo
                                                </option>
                                            </select>
                                        </div>
                                            ...
                                            @foreach($product->images()->get() as $image)
                                                <tr class="row1" data-id="{{ $image->id }}" data-action="{{$product->id}}">
                                                    ...
                                                    <td><a href="javascript:void(0)"
                                                           class="btn btn-primary btn-sm waves-effect waves-light {{ ($image->cover == true ? 'btn-success' : '') }} image-set-cover"
                                                           data-action="{{ route('admin.products.imageSetCover', ['image'=> $image->id]) }}">
                                                            <i class="mdi mdi-camera-enhance"></i> Capa</a>
                                                        <a href="javascript:void(0)"
                                                           class="btn btn-danger btn-sm waves-effect waves-light image-remove"
                                                           data-action="{{ route('admin.products.imageRemove', ['image'=> $image->id]) }}">
