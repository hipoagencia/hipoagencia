<?php $__env->startSection('content'); ?>
    ...
    <div class="main-banner-area">
        <div class="main-banner-item specialities-banner specialities-banner-urinary">
            <div class="container">
    ...
    <div class="specialities-red" style="background-color:#00b061 !important;">
        <div class="container  pb-40">
            <div class="row justify-content-center0">

                <div class="col-lg-4 text-center about-box-top">
                    <img src="<?php echo e(url(asset('web/assets/images/boston/specialities/ico1_urinary.png'))); ?>" class="w-50"/>
                    <h5>
    ...
    <div class="pt-70 pb-70 bg-gray">
        <div class="container">
            <div class="section-title">
                <h2 style="color: #00b061;">Condições Clínicas</h2>
            ...
            <div class="row justify-content-center text-center">
                ...
                <a href="#" style="background-color: #00b061;" class="btn-conditions">Fibrilação Atrial</a>
                <a href="#" style="background-color: #00b061;" class="btn-conditions">AVC</a>
                <a href="#" style="background-color: #00b061;" class="btn-conditions">Morte Súbita</a>
...
<?php echo $__env->make('web.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boston\resources\views/web/specialtyUrinary.blade.php ENDPATH**/ ?>