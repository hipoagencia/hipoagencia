        ...
        <div class="container  pb-40">
            <div class="row justify-content-center0">
                ...
                <div class="col-lg-4 text-center about-box-top">
                    <img src="<?php echo e(url(asset('web/assets/images/boston/specialities/ico1.png'))); ?>" class="w-50"/>
                    <h5>
                ...
                <div class="col-lg-4 text-center specialities-red-box-top">
                    <img src="<?php echo e(url(asset('web/assets/images/boston/specialities/ico2.png'))); ?>" class="w-50"/>
                    <h5>
                ...
                <div class="col-lg-4 text-center about-box-top">
                    <img src="<?php echo e(url(asset('web/assets/images/boston/specialities/ico3.png'))); ?>" class="w-50"/>
                    <h5>
    ...
    <div class="pt-70 pb-70 bg-gray">
        <div class="container">
            ...
            <div class="row justify-content-center text-center">
                ...
                <a href="<?php echo e(route('web.page.fibrilacaoArterial')); ?>" style="background-color: #ac1d2e;" class="btn-conditions">Fibrilação Atrial</a>
...
<?php echo $__env->make('web.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boston\resources\views/web/specialtyHeart.blade.php ENDPATH**/ ?>