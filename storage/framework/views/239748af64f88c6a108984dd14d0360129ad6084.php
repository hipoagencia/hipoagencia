    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel"
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <a href="https://saberdasaude.com.br/blog/article/festival-miolo-mole-doutores-da-alegria"><img src="<?php echo e(url(asset('web/assets/images/banner/miolo.jpg'))); ?>" class="d-block w-100"
                                 alt=""></a>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center specialities2-links">
                ...
                <div
                    ...
                    <a href="<?php echo e(route('web.category', ['slug' => 'coracao','id' => '2'])); ?>"><img
                            src="<?php echo e(url(asset('web/assets/images/boston/ico/3.png'))); ?>"/></a>
                ...
                <div
                    ...
                    <a href="<?php echo e(route('web.category', ['slug' => 'sistema-urinario','id' => '3'])); ?>"><img
                            src="<?php echo e(url(asset('web/assets/images/boston/ico/2.png'))); ?>"/></a>
                ...
                <div
                    ...
                    <a href="<?php echo e(route('web.category', ['slug' => 'canceres-e-tumores','id' => '4'])); ?>"><img
                            src="<?php echo e(url(asset('web/assets/images/boston/ico/4.png'))); ?>"/></a>
