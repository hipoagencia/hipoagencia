<?php $__env->startSection('content'); ?>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="<?php echo e((request()->route()->getName() == 'web.search' ? 'display:none' : '')); ?>">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <a href="<?php echo e(route('web.category', ['slug' => 'sistema-nervoso','id' => '1'])); ?>"><img src="<?php echo e(url(asset('web/assets/images/banner/nervoso.jpg'))); ?>" class="d-block w-100"
                     alt=""></a>
            </div>
            <div class="carousel-item">
                <a href="<?php echo e(route('web.category', ['slug' => 'coracao','id' => '2'])); ?>"><img src="<?php echo e(url(asset('web/assets/images/banner/coracao.jpg'))); ?>" class="d-block w-100"
                     alt=""></a>
            </div>
            <div class="carousel-item">
                <a href="<?php echo e(route('web.category', ['slug' => 'sistema-urinario','id' => '3'])); ?>"><img src="<?php echo e(url(asset('web/assets/images/banner/urinario.jpg'))); ?>" class="d-block w-100"
                     alt=""></a>
            </div>

            <div class="carousel-item">
                <a href="<?php echo e(route('web.category', ['slug' => 'canceres-e-tumores','id' => '4'])); ?>"><img src="<?php echo e(url(asset('web/assets/images/banner/tumor.jpg'))); ?>" class="d-block w-100"
                     alt=""></a>
            </div>

            <div class="carousel-item">
                <a href="<?php echo e(route('web.category', ['slug' => 'saude-sexual','id' => '5'])); ?>"><img src="<?php echo e(url(asset('web/assets/images/banner/sexual.jpg'))); ?>" class="d-block w-100"
                     alt=""></a>
            </div>
        </div>
    ...
    <div class="pt-70 pb-70" style="<?php echo e((request()->route()->getName() == 'web.search' ? 'display:none' : '')); ?>">
        <div class="container">
            ...
            <div class="row justify-content-center specialities2-links">
                ...
                <div class="col text-center bg-spec-gray2 blue-hover pointer <?php echo e((request()->route()->slug == 'sistema-nervoso' ? 'blue-h' : '')); ?>">
                ...
                <div class="col text-center bg-spec-gray2 red-hover pointer <?php echo e((request()->route()->slug == 'coracao' ? 'red-h' : '')); ?>">
                ...
                <div class="col text-center bg-spec-gray2 green-hover <?php echo e((request()->route()->slug == 'sistema-urinario' ? 'green-h' : '')); ?>">
                ...
                <div class="col text-center bg-spec-gray2 orange-hover <?php echo e((request()->route()->slug == 'canceres-e-tumores' ? 'orange-h' : '')); ?>">
                ...
                <div class="col text-center bg-spec-gray2 purple-hover <?php echo e((request()->route()->slug == 'saude-sexual' ? 'purple-h' : '')); ?>">
