...
<br>
                ...
                <p>Ablação por Radiofrequência (RFA)
                    A RFA é um procedimento ambulatorial minimamente invasivo que usa energia térmica para interromper os sinais de dor na fonte.
                </p>
...
<br><br>
                ...
                <p><b>Síndrome Pós-Laminectomia ou Síndrome do Insucesso (FBSS):</b></p>
                <p>Um termo que descreve a dor residual apesar de várias cirurgias nas costas ou outras intervenções, tais como manipulação espinhal, ou bloqueio de nervos, para reduzir as dores nas costas e nas pernas ou reparar déficits neurológicos.</p>

                <p><b>Síndrome da Dor Regional Complexa (SDRC):</b></p>
                <p>Uma síndrome de vários sintomas, normalmente causada por algum trauma, incluindo dor em queimadura, hiperestesia (sensibilidade aumentada de qualquer órgão do sentido, especialmente a pele sensível ao frio, calor, dor, etc.), inchaço, hiperidrose (transpiração excessiva e profusa) e alterações tróficas na pele e no osso das áreas afetadas. A estimulação de nervos periféricos pode também ser indicada como tratamento.
...
<?php echo $__env->make('web.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boston\resources\views/web/page/nervoso/dorCronica.blade.php ENDPATH**/ ?>