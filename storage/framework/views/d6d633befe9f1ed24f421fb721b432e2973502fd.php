                    ...
                    <ul class="navbar-nav m-auto">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col">
                                           <ul>
                                               ...
                                               <li class="nav-item">
                                                   <a href="<?php echo e(route('web.page.colorretal')); ?>" class="nav-link">Colorretal</a>
                                               </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('web.blog')); ?>"
                               class="nav-link <?php echo e((request()->routeIs(['web.blog','web.article']) ? 'active' : '')); ?>">Blog</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('web.contact')); ?>" class="nav-link <?php echo e((request()->route()->getName() == 'web.contact' ? 'active' : '')); ?>">Contato</a>
                        </li>
