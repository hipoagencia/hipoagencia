            ...
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('web.home')); ?>" class="nav-link <?php echo e((request()->route()->getName() == 'web.home' ? 'active' : '')); ?>">
                                Home
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('web.blog')); ?>" class="nav-link <?php echo e((request()->route()->getName() == 'web.blog' ? 'active' : '')); ?>">Blog</a>
                        </li>
                        <li class="nav-item">
