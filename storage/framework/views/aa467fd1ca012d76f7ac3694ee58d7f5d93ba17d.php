<?php $__env->startSection('content'); ?>
    ...
    <div class="main-banner-area">
        <div class="main-banner-item specialities-banner">
            <div class="container">
        ...
        <div class="container  pb-40">
            <div class="row justify-content-center0">
                ...
                <div class="col-lg-4 text-center about-box-top">
                    <img src="assets/images/boston/specialities/ico1.png" class="w-50"/>
                    <h5>
                ...
                <div class="col-lg-4 text-center specialities-red-box-top">
                    <img src="assets/images/boston/specialities/ico2.png" class="w-50"/>
                    <h5>
                ...
                <div class="col-lg-4 text-center about-box-top">
                    <img src="assets/images/boston/specialities/ico3.png" class="w-50"/>
                    <h5>
...
<?php echo $__env->make('web.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boston\resources\views/web/specialty.blade.php ENDPATH**/ ?>