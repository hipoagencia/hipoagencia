                        ...
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="home1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status">
                                                ...
                                                <option
                                                    value="1" <?php echo e(( old('status') == '1' ? 'selected' : '')); ?>>
                                                    Ativo
                                                </option>
                                                <option
                                                    value="0" <?php echo e(( old('status') == '0' ? 'selected' : '')); ?>>
                                                    Inativo
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <textarea id="elm1" class="my-editor" name="description" ><?php echo e(old('description')); ?></textarea>
                                    </div>
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boston\resources\views/admin/content/create.blade.php ENDPATH**/ ?>