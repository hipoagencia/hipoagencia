    ...
    <div class="pt-70 about-what-find" id="1">
        <div class="container">
            <div class="section-title pb-70">
                <h3 class="co-red mb-3">Qual é a diferença entre as arritmias supraventriculares (TSV) como o flutter
                    atrial e a fibrilação atrial?</h3>


                <p>É normal que sua frequência cardíaca varie durante o dia, dependendo do seu nível de atividade. Por
                    exemplo, você pode esperar que sua frequência cardíaca aumente quando está se exercitando, mas não
                    quando está sentado.</p>
                <p>Qualquer tipo de ritmo ou frequência cardíaca anormal é chamado de arritmia. Ritmos cardíacos
                    anormais rápidos, com frequências acima de 100 bpm, são denominados taquiarritmias. Taquicardia
                    supraventricular (TSV) é um termo geral para qualquer ritmo cardíaco rápido vindo de um local acima
                    dos ventrículos.</p>
                <p>Qualquer pessoa pode desenvolver uma arritmia, mesmo um jovem, sem uma condição cardíaca prévia.
                    Entretanto, as arritmias são mais comuns em pessoas com mais de 65 anos que sofreram algum dano
    ...
    <div class="about-what-find-blue co-bg-red" id="2">
        <div class="container  pb-30">
            <div class="row justify-content-center text-center">
                ...
                <p class="co-white">Você conhece o seu corpo bem o suficiente para saber quando algo está errado. Por
                    isso você deve se consultar com seu médico se estiver tendo qualquer um desses sintomas. O médico
                    talvez queira examinar seu sistema de condução a fim de determinar as melhores opções de tratamento.
                </p>
                ...
                <div class="container text-center">
                    ...
                    <ul class="list-style text-left">
                        ...
                        <li>Alguns medicamentos de prescrição, tais como certos medicamentos para gripe, tosse e
                            alergia, e antidepressivos
                        </li>
                    </ul>

                    <p>Além disso, alguns ritmos estão presentes no nascimento, como a síndrome de Wolff Parkinson
                        White, na qual um grupo de batimentos cardíacos rápidos e irregulares é causado por vias de
                        condução elétrica extras entre os átrios e os ventrículos.</p>
        ...
        <div class="container pt-70  pb-70">
            <div class="row justify-content-center text-center section-title">
                ...
                <p class="co-white">Para muitos pacientes com arritmias atriais, os medicamentos não conseguem controlar
                    ...
                    posicionado dentro do coração para administrar terapia no tecido responsável pela arritmia.</p>
                <p class="co-white">Depois de um procedimento de ablação, alguns pacientes podem precisar de um
                    marcapasso.</p>
    ...
    <div class="pt-70 about-what-find  pb-70">
        <div class="container text-center">
            <div class="section-title">
                ...
                <div class="row">
                    <p>Existem três objetivos terapêuticos a serem considerados em pacientes com fibrilação atrial (FA):
                        controle da frequência, manutenção do ritmo sinusal e prevenção de tromboembolia. Os riscos e os
                        benefícios de cada tratamento devem ser analisados e considerados para cada paciente..</p>

                    <b>Controle da Frequência Ventricular</b>
                    <p>Em pacientes sem pré-excitação ventricular, o controle agudo da frequência é eficaz com
                        bloqueadores do canal de cálcio (BCCs) ou bloqueadores. A ablação por cateter pode ser efetiva e
                        é recomendada em pacientes que não responderam às drogas utilizadas para controlar a frequência
                        ou que são intolerantes a elas.</p>

                    <b>Restauração e Manutenção do Ritmo Sinusal</b>
                    <p>Vários medicamentos podem restaurar e manter com eficácia o ritmo sinusal em pacientes com FA.
                        Existem também abordagens não-farmacológicas para a prevenção da FA, que incluem cirurgia,
                        estimulação atrial e ablação por cateter.</p>

                    <b>Redução do Risco Tromboembólico</b>
                    <p>As diretrizes de tratamento para pacientes com FA incluem a recomendação para o tratamento com
                        anticoagulantes orais para os pacientes com um ou mais fatores de risco de derrame. Estudos de
                        pacientes submetidos a oclusão do apêndice atrial esquerdo mostram uma tendência para a redução
                        de eventos embólicos, oferecendo, assim, aos médicos e pacientes, uma outra opção de
                        tratamento.</p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('web.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boston\resources\views/web/page/coracao/arritmiaArtrial.blade.php ENDPATH**/ ?>