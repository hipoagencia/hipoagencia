...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url(asset('web/assets/css/bootstrap.min.css'))); ?>">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-12 col-md-6 order-lg-first">
                    ...
                    <img src="<?php echo e(url(asset('web/assets/images/boston/woman.png'))); ?>" />
    ...
    <div class="container">
        ...
        <div class="row justify-content-center specialities-links">
            <div class="col col-6 col-lg-2 col-md-6 col-sm-6 text-center mb-5">
                <a href="#"><img src="<?php echo e(url(asset('web/assets/images/boston/ico/1.png'))); ?>"/></a>
                <h5>Sistema Nervoso</h5>
            </div>
            <div class="col col-6 col-lg-2 col-md-6 col-sm-6 text-center  mb-5">
                <a href="#"><img src="<?php echo e(url(asset('web/assets/images/boston/ico/3.png'))); ?>" /></a>
                <h5>Coração</h5>

            </div>
            <div class="col col-6 col-lg-2 col-md-6 col-sm-6 text-center  mb-5">
                <a href="#"><img src="<?php echo e(url(asset('web/assets/images/boston/ico/2.png'))); ?>" /></a>
                <h5>Sistema Urinário</h5>
            </div>

            <div class="col col-6 col-lg-2 col-md-6 col-sm-6 text-center  mb-5">
                <a href="#"><img src="<?php echo e(url(asset('web/assets/images/boston/ico/4.png'))); ?>" /></a>
                <h5>Cânceres e Tumores</h5>

            </div>
            <div class="col col-6 col-lg-2 col-md-6 col-sm-6 text-center  mb-5">
                <a href="#"><img src="<?php echo e(url(asset('web/assets/images/boston/ico/5.png'))); ?>" /></a>
                <h5>Saúde Sexual</h5>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 text-center">
                ...
                <span onclick="openBrain()" class="pointer"><img src="<?php echo e(url(asset('web/assets/images/boston/body/1.jpg'))); ?>"/></span>
                <img src="<?php echo e(url(asset('web/assets/images/boston/body/2.jpg'))); ?>" />
                <span onclick="openHeart()" class="pointer"><img src="<?php echo e(url(asset('web/assets/images/boston/body/3.jpg'))); ?>" /></span>
                <img src="<?php echo e(url(asset('web/assets/images/boston/body/4.jpg'))); ?>" />
                <span onclick="openUrine()" class="pointer"><img src="<?php echo e(url(asset('web/assets/images/boston/body/5.jpg'))); ?>" /></span>
                <span onclick="openCancer()" class="pointer"><img src="<?php echo e(url(asset('web/assets/images/boston/body/6.jpg'))); ?>" /></span>
                <span onclick="openSexual()" class="pointer"><img src="<?php echo e(url(asset('web/assets/images/boston/body/7.jpg'))); ?>" /></span>
            ...
            <div class="col-lg-4">
                <article class="blog-post">
                    <div class="blog-post-title" style="background-color: #ac1d2e;">
                        <h5 class="font-light"><img src="<?php echo e(url(asset('web/assets/images/boston/ico/ico-coracao.png'))); ?>"/> Coração</h5>
                    </div>
...
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/jquery.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/bootstrap.bundle.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/jquery.meanmenu.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/owl.carousel.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/jquery.appear.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/odometer.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/nice-select.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/jquery.magnific-popup.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/jquery.ajaxchimp.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/form-validator.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/contact-form-script.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/wow.min.js'))); ?>">
<link rel="stylesheet" href="<?php echo e(url(asset('web/assets/js/main.js'))); ?>">
...
<?php /**PATH C:\xampp\htdocs\boston\resources\views/web/home.blade.php ENDPATH**/ ?>