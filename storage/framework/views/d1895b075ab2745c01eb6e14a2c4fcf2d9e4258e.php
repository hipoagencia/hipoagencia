<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
           <a href="https://saberdasaude.com.br/especialidade/sistema-nervoso/distonia"><img src="<?php echo e(url(asset('web/assets/images/banner/banner_distonia.jpg'))); ?>" class="img-fluid"/></a>
        </div>
