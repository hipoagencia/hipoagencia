...
<?php echo $__env->renderComponent(); ?>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.ead-module.store')); ?>" method="POST"
                          autocomplete="false"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="formrow-inputState" class="form-select" name="user_id">
                                                ...
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($user->id); ?>" <?php echo e((old('user') == $user->id ? 'selected' : '' )); ?>><?php echo e($user->name); ?> <?php echo e($user->last_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <select name="premium" class="form-select">
                                                ...
                                                <option
                                                    value="0" <?php echo e((old('premium') == '0' ? 'selected' : '')); ?>>
                                                    Não
                                                </option>
                                                <option
                                                    value="1" <?php echo e((old('premium') == '1' ? 'selected' : '')); ?> selected>
                                                    Sim
                                                </option>
                                            </select>
                                        </div>
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HipoPainel\resources\views/admin/eadModule/create.blade.php ENDPATH**/ ?>