...
<head>
    ...
    <meta charset="utf-8" />
    <title><?php echo e(env('APP_NAME')); ?> - Entre com a sua conta!</title>
    ...
    <!-- Bootstrap Css -->
    <link href="<?php echo e(url(asset('backend/assets/css/bootstrap.min.css'))); ?>" id="bootstrap-style" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        <p>© <script>document.write(new Date().getFullYear())</script> <?php echo e(env('APP_NAME')); ?>. Desenvolvido com <i class="mdi mdi-heart text-danger"></i> por
...
<?php /**PATH C:\xampp\htdocs\boston\resources\views/admin/master/masterLogin.blade.php ENDPATH**/ ?>