...
<?php echo $__env->renderComponent(); ?>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.ead-module.update', ['ead_module' => $module->id])); ?>" method="POST"
                          autocomplete="false"
                        ...
                        <div class="tab-content p-3 text-muted">
                            <div class="tab-pane active" id="home1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="name" class="form-control"
                                                   value="<?php echo e(old('name') ?? $module->name); ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="formrow-inputState" class="form-select" name="user_id">
                                                ...
                                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($user->id); ?>" <?php echo e(( $module->user_id == $user->id ? 'selected' : ( old('user_id') == $user->id ? 'selected' : '' ) )); ?>><?php echo e($user->name); ?> <?php echo e($user->last_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            <label for="premium" class="form-label">Conteúdo para assinates?</label>
                                            <select name="premium" class="form-select">
                                                <option selected>Escolha...</option>
                                                <option
                                                    value="0" <?php echo e((old('premium') == '0' ? 'selected' : ($module->premium == '0' ? 'selected' : ''))); ?>>
                                                    Não
                                                </option>
                                                <option
                                                    value="1" <?php echo e((old('premium') == '1' ? 'selected' : ($module->premium == '1' ? 'selected' : ''))); ?>>
                                                    Sim
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="select2 form-control select2-multiple"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($category->id); ?>" <?php echo e($category->id); ?>" <?php echo e(($module->categories->find($category->id) == true ? 'selected' : (in_array($category->id, old("categories") ?: []) ? "selected" : ""))); ?>><?php echo e($category->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    ...
                                    <div class="mb-3 mt-3">
                                        <textarea id="elm1" name="description" ><?php echo e(old('description') ?? $module->description); ?></textarea>
                                    </div>
                            ...
                            <div class="tab-pane" id="profile1" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="content_image row">
                                        <div class="col-4">
                                            <img src="<?php echo e(asset($module->cover)); ?>" class="img-fluid"><br><br>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="headline" class="form-control"
                                                   value="<?php echo e(old('headline') ?? $module->headline); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input name="slug" class="form-control"
                                                   value="<?php echo e(old('slug') ?? $module->slug); ?>">
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HipoPainel\resources\views/admin/eadModule/edit.blade.php ENDPATH**/ ?>