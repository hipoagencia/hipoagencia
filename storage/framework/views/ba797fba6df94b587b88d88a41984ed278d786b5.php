        ...
        <div class="container  pb-40">
            <div class="row justify-content-center0">
                ...
                <div class="col-lg-4 text-center about-box-top">
                    <img src="<?php echo e(url(asset('web/assets/images/boston/specialities/ico1_cancer.png'))); ?>" class="w-50"/>
                    <h5>
...
<?php echo $__env->make('web.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\boston\resources\views/web/specialtyCancer.blade.php ENDPATH**/ ?>